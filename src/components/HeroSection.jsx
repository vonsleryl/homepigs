      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 grid grid-cols-2 gap-4">
            <img src={image1} alt="Description 1" className="rounded-lg shadow-md" />
            <img src={image2} alt="Description 2" className="rounded-lg shadow-md" />
            <img src={image3} alt="Description 3" className="rounded-lg shadow-md" />
            <img src={image4} alt="Description 4" className="rounded-lg shadow-md" />
          </div>
        </div>
      </div>
    </div>
